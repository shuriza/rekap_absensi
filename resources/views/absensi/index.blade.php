    ...
    <div class="bg-white p-6 rounded-xl shadow border">
      ...
      <form method="POST" action="{{ route('absensi.preview') }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          ...
          <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                <label class="block text-sm font-medium text-gray-700">Masuk
                  Minimal</label>
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700">Pulang
                  Minimal</label>
                <div class="mt-1 relative">
        ...
        <button type="button" id="toggleRamadhanFilter"
          class="mb-6 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 focus:outline-none">
          🌙 Tampilkan Filter Khusus Ramadhan
        </button>

        {{-- Section Ramadhan (hidden default) --}}
        <div id="ramadhanSection" class="hidden grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">

          {{-- Ramadhan: Senin – Kamis --}}
          <div class="bg-white shadow rounded-lg p-6 border-purple-300 border-2 ">
            <h2 class="text-xl font-semibold mb-4 text-purple-800">🌙 Filter Jam Ramadhan: Senin –
              Kamis</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                ...
                <input type="time" name="jam_masuk_min_ramadhan_senin"
                  ...
                  class="mt-1 block w-full p-2 border rounded-md focus:ring-purple-500" />
              </div>
              <div>
          ...
          {{-- Ramadhan: Jumat --}}
          <div class="bg-white shadow rounded-lg p-6 border-purple-300 border-2">
            <h2 class="text-xl font-semibold mb-4 text-purple-800">🌙 Filter Jam Ramadhan: Jumat</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                <label class="block text-sm font-medium text-gray-700">Masuk Minimal</label>
          ...
          <div>
            <label for="ramadhan_dates" class="block text-sm font-medium text-gray-700">Tandai
              Rentang Tanggal</label>
            <input type="text" name="ramadhan_dates" id="ramadhan_dates"
              value="{{ old('ramadhan_dates') }}" placeholder="Pilih tanggal awal & akhir"
              class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:ring-purple-500" />
          </div>
        ...
        <div class="mb-8">
          ...
          <div class="mt-2 flex items-center space-x-4">
            <button type="button" onclick="document.getElementById('file_input').click()"
              class="inline-flex items-center px-4 py-2 bg-white border-2 border-indigo-500 rounded-lg text-indigo-600 hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-300">
          ...
          <ul id="file_list"
            class="mt-4 border border-gray-200 rounded-lg divide-y divide-gray-200 bg-white"></ul>
          <button type="submit"
            class="mt-6 w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow focus:outline-none focus:ring-2 focus:ring-blue-400">
            Preview Data
          </button>
        </div>
      </form>
          ...
          document.addEventListener('DOMContentLoaded', () => {
            ...
            btn.addEventListener('click', () => {
              ...
              btn.textContent = section.classList.contains('hidden') ?
                '🌙 Tampilkan Filter Khusus Ramadhan' :
                '❌ Sembunyikan Filter Khusus Ramadhan';
            });

            // Flatpickr for date range
            flatpickr("#ramadhan_dates", {
              mode: "range",
              dateFormat: "Y-m-d",
              locale: {
                rangeSeparator: " - "
            ...
            function renderFiles() {
              ...
              Array.from(dt.files).forEach((file, i) => {
                ...
                li.innerHTML = `
                  ...
                  <button type=\"button\" class=\"text-red-500 hover:text-red-700\" data-idx=\"${i}\">&times;</button>
                `;
